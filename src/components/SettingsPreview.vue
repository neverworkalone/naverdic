...
.settings-reset-danger-card__badge { position: absolute; top: 27px; left: 23px; display: inline-flex; width: 78px; height: 26px; align-items: center; justify-content: center; color: #d94c4c; background: #fff4f4; border: 1px solid #f1caca; border-radius: 13px; font-size: 11px; font-weight: 600; line-height: 18px; }
...
.settings-reset-danger-card__description { position: absolute; top: 111px; left: 23px; width: 252px; margin: 0; color: #b54747; font-size: 11px; line-height: 22px; }
.settings-reset-danger-card__button { position: absolute; top: 207px; left: 23px; display: inline-flex; width: 148px; height: 36px; align-items: center; justify-content: center; padding: 0 12px; color: #fff; background: #d94c4c; border: 1px solid #d94c4c; border-radius: 8px; font-size: 11px; font-weight: 700; line-height: 18px; cursor: pointer; }
